    ...
    function h(e, f, g) {
        function i(a, b, c) {
            ...
            var d, e, f, h = [],
                i = 0,
                j = o();
            ga = void 0 !== ea ? ea.maxLength : void 0, ga === -1 && (ga = void 0);
            do {
                if (a === !0 && m().validPositions[i]) {
                    var k = m().validPositions[i];
                    e = k.match, d = k.locator.slice(), h.push(c === !0 ? k.input : H(i, e))
                } else f = r(i, d, i - 1), e = f.match, d = f.locator.slice(), (g.jitMasking === !1 || i < j || isFinite(g.jitMasking) && g.jitMasking > i) && h.push(H(i, e));
                i++
        ...
        function p(b, c, d, e) {
            ...
            for (n(!0), h = i + 1; h <= o();) {
                ...
                if (h < i && (h = i + 1), void 0 === m().validPositions[h] && C(h) || void 0 !== l) h++;
                else {
                    var p = r(h);
                    k === !1 && j[i] && j[i].match.def === p.match.def ? (m().validPositions[i] = a.extend(!0, {}, j[i]), m().validPositions[i].input = p.input, delete m().validPositions[h], h++) : t(i, p.match.def) ? B(i, p.input || H(h), !0) !== !1 && (delete m().validPositions[h], h++, k = !0) : C(h) || (h++, i--), i++
                }
            }
            n(!0)
        }
        ...
        function v(b, c, d) {
            ...
            if (b > -1) {
                if (void 0 === c) {
                    for (var r, s = b - 1; void 0 === (r = m().validPositions[s] || m().tests[s]) && s > -1;) s--;
        ...
        function y(a, b, c) {
            ...
            for (d = a; d < b; d++) n(!0), c[d] !== g.skipOptionalPartCharacter && B(d, c[d], !0, !0)
        }
        ...
        function B(c, d, e, f, h) {
            ...
            function j(b, d, e) {
                ...
                return a.each(v(b), function(j, k) {
                    for (var l = k.match, q = d ? 1 : 0, r = "", t = l.cardinality; t > q; t--) r += F(b - (t - 1));
                    if (d && (r += d), x(!0), h = null != l.fn ? l.fn.test(r, m(), b, e, g, i(c)) : (d === l.def || d === g.skipOptionalPartCharacter) && "" !== l.def && {
                        ...
                        if (void 0 !== h.remove && (a.isArray(h.remove) || (h.remove = [h.remove]), a.each(h.remove.sort(function(a, b) {
                            ...
                            if (e = !0, y(A === !0 ? A : A.start, A.end, w), void 0 === h.pos && void 0 === h.c) return h.pos = o(), !1;
                            if (v = void 0 !== h.pos ? h.pos : b, v !== b) return h = a.extend(h, B(v, u, !0, f)), !1
                        } else if (h !== !0 && void 0 !== h.pos && h.pos !== b && (v = h.pos, y(b, v, x().slice()), v !== b)) return h = a.extend(h, B(v, u, !0)), !1;
                    ...
                    a.each(v(q, x ? x.locator : void 0, q - 1), function(e, i) {
                        ...
                        for (var j = 0; j < p.length; j++) {
                            ...
                            if (u < p[j] && (void 0 === i.na || a.inArray(p[j], i.na.split(",")) === -1)) {
                                ...
                                for (m().validPositions[q].locator[h] = parseInt(p[j]), null == i.match.fn ? (w.input !== i.match.def && (y = !0, w.generatedInput !== !0 && t.push(w.input)), x++, m().validPositions[q].generatedInput = !/[0-9a-bA-Z]/.test(i.match.def), m().validPositions[q].input = i.match.def) : m().validPositions[q].input = w.input, k = q + 1; k < o(void 0, !0) + 1; k++) l = m().validPositions[k], l && l.generatedInput !== !0 && /[0-9a-bA-Z]/.test(l.input) ? t.push(l.input) : k < b && v++, delete m().validPositions[k];
                                for (y && t[0] === i.match.def && t.shift(), n(!0), s = !0; t.length > 0;) {
                                    var A = t.shift();
                                    if (A !== g.skipOptionalPartCharacter && !(s = B(o(void 0, !0) + 1, A, !1, f, !0))) break
                                }
                                if (s) {
                                    m().validPositions[q].locator = z;
                                    var C = o(b) + 1;
                                    for (k = q + 1; k < o() + 1; k++) l = m().validPositions[k], (void 0 === l || null == l.match.fn) && k < b + (x - v) && x++;
                                    b += x - v, s = B(b > C ? C : b, c, d, f, !0)
                                }
                                if (s) return !1;
                ...
                for (var d = m().validPositions[c], e = d.locator, f = e.length, g = b; g < c; g++)
                    if (void 0 === m().validPositions[g] && !C(g, !0)) {
                        ...
                        a.each(h, function(a, b) {
                            for (var c = 0; c < f && (void 0 !== b.locator[c] && A(b.locator[c].toString().split(","), e[c].toString().split(","))); c++) j < c && (j = c, i = b)
                        }), s(g, a.extend({}, i, {
                    ...
                    for (f = j = b; f <= i; f++) {
                        ...
                        if (void 0 !== r)
                            for (var s = j; s < m().maskLength && (null == r.match.fn && l[f] && (l[f].match.optionalQuantifier === !0 || l[f].match.optionality === !0) || null != r.match.fn);) {
                                if (s++, p === !1 && h[s] && h[s].match.def === r.match.def) m().validPositions[s] = a.extend(!0, {}, h[s]), m().validPositions[s].input = r.input, u(s), j = s, k = !0;
                                else if (t(s, r.match.def)) {
                                    var v = B(s, r.input, !0, !0);
                                    k = v !== !1, j = v.caret || v.insert ? o() : s, p = !0
                                } else k = r.generatedInput === !0;
                                if (m().maskLength < q && (m().maskLength = q), k) break
                            }
                        if (!k) break
                    }
        ...
        function C(a, b) {
            var c;
            if (b ? (c = r(a).match, "" === c.def && (c = s(a).match)) : c = s(a).match, null != c.fn) return c.fn;
            if (b !== !0 && a > -1) {
                var d = v(a);
        ...
        function G(b, c, d, e, f) {
            ...
            b.inputmask._valueSet(c.join("")), void 0 === d || void 0 !== e && "blur" === e.type || K(b, d), f === !0 && (ka = !0, a(b).trigger("input"))
        }

        function H(a, b) {
            if (b = b || s(a).match, void 0 !== b.placeholder) return b.placeholder;
            if (null === b.fn) {
            ...
            if (a.each(k, function(b, d) {
                    if (void 0 !== d) {
                        ...
                        if (!j() || e || g.autoUnmask) {
                            ...
                            q = R.call(c, f, !0, !1, e, s), p = s + 1, l = ""
                        } else q = R.call(c, f, !0, !1, !0, h + 1);
                        if (!e && a.isFunction(g.onBeforeWrite) && (q = g.onBeforeWrite(f, x(), q.forwardPosition, g), q && q.refreshFromBuffer)) {
                            ...
                            y(t === !0 ? t : t.start, t.end, q.buffer), n(!0), q.caret && (m().p = q.caret)
                        }
                    }
                }), d) {
                var u = void 0,
                    v = o();
                document.activeElement === c && (h || q) && (u = K(c).begin, h && q === !1 && (u = D(o(u))), q && i !== !0 && (u < v + 1 || v === -1) && (u = g.numericInput && void 0 === q.caret ? E(q.forwardPosition) : q.forwardPosition)), G(c, x(), u, h || new a.Event("checkval"))
            }
        }
            ...
            function h() {
                if (g.keepStatic) {
                    for (var b = [], d = o(-1, !0), e = a.extend(!0, {}, m().validPositions), f = m().validPositions[d]; d >= 0; d--) {
                        ...
                        if (h) {
                            if (h.generatedInput !== !0 && /[0-9a-bA-Z]/.test(h.input) && b.push(h.input), delete m().validPositions[d], void 0 !== h.alternation && h.locator[h.alternation] !== f.locator[h.alternation]) break;
                            f = h
                        }
                    }
                    if (d > -1)
                        for (m().p = D(o(-1, !0)); b.length > 0;) {
                            ...
                            i.which = b.pop().charCodeAt(0), R.call(c, i, !0, !1, !1, m().p)
        ...
        function Q(d) {
            var e = this,
                ...
                h = d.keyCode,
                i = K(e);
            if (h === b.keyCode.BACKSPACE || h === b.keyCode.DELETE || l && h === b.keyCode.BACKSPACE_SAFARI || d.ctrlKey && h === b.keyCode.X && !c("cut")) d.preventDefault(), P(e, h, i), G(e, x(!0), m().p, d, e.inputmask._valueGet() !== x().join("")), e.inputmask._valueGet() === w().join("") ? f.trigger("cleared") : N(x()) === !0 && f.trigger("complete"), g.showTooltip && (e.title = g.tooltip || m().mask);
            else if (h === b.keyCode.END || h === b.keyCode.PAGE_DOWN) {
                d.preventDefault();
                var j = D(o());
                g.insertMode || j !== m().maskLength || d.shiftKey || j--, K(e, d.shiftKey ? i.begin : j, j, !0)
            ...
            g.onKeyDown.call(this, d, x(), K(e).begin, g), la = a.inArray(h, g.ignorables) !== -1
        }
            ...
            if (k) {
                ...
                if (q !== !1 && (n(!0), l = void 0 !== q.caret ? q.caret : d ? q.pos + 1 : D(q.pos), m().p = l), e !== !1) {
                    ...
                    if (setTimeout(function() {
                        ...
                        var s = x();
                        G(i, s, g.numericInput && void 0 === q.caret ? E(l) : l, c, d !== !0), d !== !0 && setTimeout(function() {
        ...
        function S(b) {
            ...
            if (j === (ia ? w().reverse() : w()).slice(0, i.begin).join("") && (j = ""), k === (ia ? w().reverse() : w()).slice(i.end).join("") && (k = ""), ia && (c = j, j = k, k = c), window.clipboardData && window.clipboardData.getData) h = j + window.clipboardData.getData("Text") + k;
            else {
        ...
        function T(c) {
            ...
            if (x().join("") !== e) {
                ...
                if (f.begin > e.length && (K(d, e.length), f = K(d)), x().length - e.length !== 1 || e.charAt(f.begin) === x()[f.begin] || e.charAt(f.begin + 1) === x()[f.begin] || C(f.begin)) {
                    ...
                    e = e.replace(j, ""), e = e.split(""), I(d, !0, !1, e, c, f.begin < i), N(x()) === !0 && a(d).trigger("complete")
                } else c.keyCode = b.keyCode.BACKSPACE, Q.call(d, c);
                c.preventDefault()
            }
        }
        ...
        function U(b) {
            ...
            I(c, !0, !1, (a.isFunction(g.onBeforeMask) ? g.onBeforeMask(d, g) || d : d).split("")), da = x().join(""), (g.clearMaskOnLostFocus || g.clearIncomplete) && c.inputmask._valueGet() === w().join("") && c.inputmask._valueSet("")
        }

        function V(a) {
            var b = this,
                c = b.inputmask._valueGet();
            g.showMaskOnFocus && (!g.showMaskOnHover || g.showMaskOnHover && "" === c) ? b.inputmask._valueGet() !== x().join("") && G(b, x(), D(o())) : ma === !1 && K(b, D(o())), g.positionCaretOnTab === !0 && setTimeout(function() {
                X.apply(this, [a])
            }, 0), da = x().join("")
        }
                    ...
                    if (b.begin === b.end) switch (g.positionCaretOnClick) {
                        ...
                        default:
                            var f = b.begin,
                                h = o(f, !0),
                                i = D(h);
                            if (f < i) K(d, C(f) || C(f - 1) ? f : D(f));
                            else {
                                var j = H(i);
                                ("" !== j && x()[i] !== j && s(i).match.optionalQuantifier !== !0 || !C(i, !0) && s(i).match.def === j) && (i = D(i)), K(d, i)
                            }
                    }
                }
            }, 0)
        ...
        function Z(c) {
            ...
            i.setData("text", ia ? j.reverse().join("") : j.join("")), document.execCommand && document.execCommand("copy"), P(d, b.keyCode.DELETE, f), G(d, x(), m().p, c, da !== x().join("")), d.inputmask._valueGet() === w().join("") && e.trigger("cleared"), g.showTooltip && (d.title = g.tooltip || m().mask)
        }
        ...
        function $(b) {
            ...
            if (d.inputmask) {
                ...
                da !== f.join("") && setTimeout(function() {
                    c.trigger("change"), da = f.join("")
                }, 0), "" !== e && (g.clearMaskOnLostFocus && (o() === -1 && e === w().join("") ? f = [] : M(f)), N(f) === !1 && (setTimeout(function() {
        ...
        function _(a) {
            var b = this;
            ma = !0, document.activeElement !== b && g.showMaskOnHover && b.inputmask._valueGet() !== x().join("") && G(b, x())
        }

        function aa(a) {
            da !== x().join("") && fa.trigger("change"), g.clearMaskOnLostFocus && o() === -1 && ea.inputmask._valueGet && ea.inputmask._valueGet() === w().join("") && ea.inputmask._valueSet(""), g.removeMaskOnSubmit && (ea.inputmask._valueSet(ea.inputmask.unmaskedvalue(), !0), setTimeout(function() {
                G(ea, x())
            }, 0))
        }
        ...
        function ca(b) {
            if (ea = b, fa = a(ea), g.showTooltip && (ea.title = g.tooltip || m().mask), ("rtl" === ea.dir || g.rightAlign) && (ea.style.textAlign = "right"), ("rtl" === ea.dir || g.numericInput) && (ea.dir = "ltr", ea.removeAttribute("dir"), ea.inputmask.isRTL = !0, ia = !0), na.off(ea), O(ea), d(ea, g) && (na.on(ea, "submit", aa), na.on(ea, "reset", ba), na.on(ea, "mouseenter", _), na.on(ea, "blur", $), na.on(ea, "focus", V), na.on(ea, "mouseleave", W), na.on(ea, "click", X), na.on(ea, "dblclick", Y), na.on(ea, "paste", S), na.on(ea, "dragdrop", S), na.on(ea, "drop", S), na.on(ea, "cut", Z), na.on(ea, "complete", g.oncomplete), na.on(ea, "incomplete", g.onincomplete), na.on(ea, "cleared", g.oncleared), g.inputEventOnly !== !0 && (na.on(ea, "keydown", Q), na.on(ea, "keypress", R)), na.on(ea, "input", T)), na.on(ea, "setvalue", U), w(), "" !== ea.inputmask._valueGet() || g.clearMaskOnLostFocus === !1 || document.activeElement === ea) {
                ...
                I(ea, !0, !1, c.split(""));
                var e = x().slice();
                da = e.join(""), N(e) === !1 && g.clearIncomplete && n(), g.clearMaskOnLostFocus && document.activeElement !== ea && (o() === -1 ? e = [] : M(e)), G(ea, e), document.activeElement === ea && K(ea, D(o()))
            }
        }
        var da, ea, fa, ga, ha, ia = !1,
            ja = !1,
            ka = !1,
            la = !1,
            ma = !0,
                    ...
                    var f = function(c) {
                        if (void 0 === this.inputmask && "FORM" !== this.nodeName) {
                            ...
                            if ("setvalue" === c.type || !(this.disabled || this.readOnly && !("keydown" === c.type && c.ctrlKey && 67 === c.keyCode || g.tabThrough === !1 && c.keyCode === b.keyCode.TAB))) {
                                switch (c.type) {
                                    case "input":
                                        if (ka === !0) return ka = !1, c.preventDefault();
                                        break;
                                    case "keydown":
                                        ja = !1, ka = !1;
                                        break;
        ...
        if (void 0 !== e) switch (e.action) {
            ...
            case "mask":
                ea = e.el, f = ea.inputmask.maskset, g = ea.inputmask.opts, ia = ea.inputmask.isRTL, ca(ea);
                break;
            case "format":
            ...
            case "isValid":
                g.numericInput && (ia = !0), e.value ? (ha = e.value.split(""), I(void 0, !1, !0, ia ? ha.reverse() : ha)) : e.value = x().join("");
                for (var oa = x(), pa = L(), qa = oa.length - 1; qa > pa && !C(qa); qa--);
                return oa.splice(pa, qa + 1 - pa), N(oa) && e.value === x().join("");
            case "getemptymask":
                return w().join("");
            case "remove":
                ea = e.el, fa = a(ea), f = ea.inputmask.maskset, g = ea.inputmask.opts, ea.inputmask._valueSet(J(ea)), na.off(ea);
                var ra;

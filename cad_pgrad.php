                ...
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        <li>
                            ...
                            <a href="cad_pgrad.php">Cadastro de Posto / Graduação</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="panel">
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="inline-validation" action="conf_pgrad.php" method="post">
                                        <div class="form-group">
                                            <label for="inputMaxLength" class="control-label">Entre com a descrição do Posto / Graduação:</label>
                                            <input type="text" class="form-control" id="inputMaxLength" name="pgrad" placeholder="Posto / Graduação" maxlength="20" required="Campo obrigatório">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputMaxLength" class="control-label">Entre com a Sigla do Posto / Graduação:</label>
                                            <input type="text" class="form-control" id="inputMaxLength" name="siglapg" placeholder="Sigla Posto / Graduação" maxlength="10" required="Campo obrigatório">
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="panel-content">
                            <table id="responsive-table" class="data-table table table-striped table-hover responsive nowrap"
                                ...
                                while ($reg = $consulta->fetch(PDO::FETCH_ASSOC)) :
                                    ...
                                    echo("<tr>");
                                    echo("<td>".$reg['id']."</td>");
                                    echo("<td>".$reg['postograd']."</td>");
                                    echo("<td>".$reg['pgradsimples']."</td>");
                                    echo("</tr>");
                                endwhile;
                                ?>
                                </tbody>

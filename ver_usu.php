                        ...
                        <div class="leftside-content-header">
                            <ul class="breadcrumbs">
                                <li>
                                    ...
                                    <a href="ver_usu.php">Verificação de dados de Usuários</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <form id="inline-validation" action="ver_usu_dados.php" method="post">
                                            ...
                                            <div class="col-md-12">                   
                                                <div class="form-group">
                                                    ...
                                                    <select name="usuario" id="select2-example-basic" class="form-control" style="width: 100%" required>
                                                        ...
                                                        $consulta = $pdo->prepare("SELECT * FROM usuarios ORDER BY idpgrad, nomecompleto ASC");
                                                        $consulta->execute();
                                                        ...
                                                        while ($reg = $consulta->fetch(PDO::FETCH_ASSOC)) :
                                                            ...
                                                            while ($linha = $pgrad->fetch(PDO::FETCH_ASSOC)):
                                                                if ($linha['id'] == $idpgrad) {
                                                                    echo("<option value=" . $reg['id'] . ">" . $linha['pgradsimples'] . "  - " . $reg['nomecompleto'] . " (".$reg['nomeguerra'].")</option>");
                                                                }
                                                            endwhile;
                                                        endwhile;
                                                        echo("</optgroup>");

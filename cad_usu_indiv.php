                        ...
                        <div class="leftside-content-header">
                            <ul class="breadcrumbs">
                                <li>
                                    ...
                                    <a href="<?php echo('cad_usu_indiv.php?tkusr=' . base64_encode($idusuario)) ?>">Atualização de dados </a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <form id="inline-validation" action="<?php echo('conf_usu_indiv.php?tkusr=' . base64_encode($idusuario)); ?>" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">                                    
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo($nomecompleto); ?>" id="inputMaxLength" name="nome" placeholder="Nome Completo" maxlength="100" required="Campo obrigatório">
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputMaxLength" class="control-label">Nome de Guerra:</label>
                                                    <input type="text" class="form-control" id="inputMaxLength2" name="guerra" value="<?php echo($nomeguerra); ?>" placeholder="Nome de Guerra" maxlength="50" required="Campo obrigatório">
                                                </div>                                        
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo($endereco); ?>" id="inputMaxLength3" name="endereco" placeholder="Endereço" maxlength="100" required="Campo obrigatório">                                            
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<?php echo($cidade); ?>" id="inputMaxLength4" name="cidade" value="Cáceres" placeholder="Cidade" maxlength="100" required="Campo obrigatório">                                            
                                                </div>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label for="inputMaxLength" class="control-label">Estado:</label>
                                                        <input type="text" class="form-control" value="<?php echo($estado); ?>" id="inputMaxLength6" name="estado" value="Mato Grosso" placeholder="Estado" maxlength="100" required="Campo obrigatório">                                            
                                                    </div>                                         
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-sm">
                                                        ...
                                                        <input type="text" class="form-control" value="<?php echo($identidade); ?>" name="identidade" placeholder="Identidade - Apenas números" disabled="Campo não pode ser editado">                                                        
                                                    </div>

                ...
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        <li>
                            ...
                            <a href="cad_setor.php">Cadastro de Setores</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="col-md-12">
                                    <form id="inline-validation" action="conf_setor.php" method="post">
                                        <div class="form-group">
                                            <label for="inputMaxLength" class="control-label">Entre com o Setor de bairros:</label>
                                            <input type="text" class="form-control" id="inputMaxLength" name="setor" placeholder="setor" maxlength="30" required="Campo obrigatório">
                                        </div>
                                        <div class="form-group">
